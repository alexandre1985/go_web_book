...
func main() {
	...
	goth.UseProviders(
		linkedin.New(config.LINKEDIN_KEY, config.LINKEDIN_SECRET, "http://localhost:8080/auth/linkedin/callback"),
		facebook.New(config.FACEBOOK_KEY, config.FACEBOOK_SECRET, "http://localhost:8080/auth/facebook/callback"),
	)
